...
> _These numbers measure the **LLM-call cache** (`Query → Response`) of the [Pomerene](https://atc-dashboard-604846394197.us-central1.run.app) stack. **Pomerene**, the flagship agent-trajectory cache, publishes its own live, client-verifiable [receipts](https://atc-dashboard-604846394197.us-central1.run.app/receipts)._
